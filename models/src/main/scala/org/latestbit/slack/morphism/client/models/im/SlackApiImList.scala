...
/**
 * Request of https://api.slack.com/methods/im.list
 */
case class SlackApiImListRequest( cursor: Option[String] = None, limit: Option[Long] = None )

/**
 * Response of https://api.slack.com/methods/im.list
 */
case class SlackApiImListResponse(
    ims: List[SlackChannelInfo],
    response_metadata: Option[SlackApiResponseMetadata] = None
) extends SlackApiScrollableResponse[SlackChannelInfo, String] {

  override def items: List[SlackChannelInfo] = ims
