...
/**
 * Request of https://api.slack.com/methods/im.history
 */
case class SlackApiImHistoryRequest(
    channel: String,
...
/**
 * Response of https://api.slack.com/methods/im.history
 */
case class SlackApiImHistoryResponse(
