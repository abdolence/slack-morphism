...
/**
 * Request of https://api.slack.com/methods/dnd.setSnooze
 */
case class SlackApiDndSetSnoozeRequest()

/**
 * Response of https://api.slack.com/methods/dnd.setSnooze
 */
case class SlackApiDndSetSnoozeResponse(
