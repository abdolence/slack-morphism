...
/**
 * Request of https://api.slack.com/methods/dnd.teamInfo
 */
case class SlackApiDndTeamInfoRequest( users: List[String] )

/**
 * Response of https://api.slack.com/methods/dnd.teamInfo
 */
case class SlackApiDndTeamInfoResponse( users: Map[String, SlackApiDndUserInfo] )

case class SlackApiDndUserInfo(
